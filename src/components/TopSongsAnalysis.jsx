...
const TopSongsAnalysis = ({topSongStats: stats}) => {
  ...
  console.log("dataforTopSongsSpider",stats)
    ...
    function getAverageThing(array) {
      ...
      if (array.length === 0 || array.every(val => val === 0)) {
          return 0;
      }
      ...
      {stats && indStat? ( <>
        ...
        <ResponsiveContainer>
          <RadarChart cx="50%" cy="50%" outerRadius="90%" data={averageStat}>
            ...
            <PolarRadiusAxis />
            <Radar name="Mike" dataKey="value" stroke="#43ff64d9" fill="#004a06" fillOpacity={0.6} />
          </RadarChart>
        </ResponsiveContainer>
        </>
      ) : null}
